...
-(void)viewDidLoad {
    ...
    NSArray *array = [[NSArray alloc] initWithObjects:@"Who Hash",
                      @"Bubba Gump Shrimp Etouffee",@"Who Pudding"
                      ,@"Scooby Snacks",@"Everlasting Gobstopper",
                      @"Green Eggs and Ham",@"Soylent Green",@"Hard Track",
                      @"Lembas Bread",@"Roast Beast",@"Blancmange", nil];
    self.list = array;
    [array release];
